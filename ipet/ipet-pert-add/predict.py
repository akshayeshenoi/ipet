# usage predict.py 25000 <dev_id> <generation>
# predict.py 25000 smrtthings 2
...
def load_gen(device, epoch):
    model_path = '../ipet-pert-train/Models/Generators/Epoch_'+str(epoch)+'/generator_'+str(device) + '.0'
